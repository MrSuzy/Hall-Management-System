 ...
 * @author user
 */
public class adminSchedulerMenu extends javax.swing.JFrame {

    /**
     * Creates new form adminSchedulerMenu
     */
    public adminSchedulerMenu() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(adminSchedulerMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new adminSchedulerMenu().setVisible(true);
            }
        });
    }
